...
public class SeckillController {
    ...
    public String list(Model model) {
        ...
        model.addAttribute("title","秒杀列表页");
        return "seckill/list";
    }
    ...
    public String detail(@PathVariable("seckillId") Long seckillId, Model model) {
        ...
        model.addAttribute("title","秒杀详情页");
